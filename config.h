...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_cyan,  col_crimson },
};
...
static Keychord keychords[] = {
	...
	{1, {{MODKEY|ShiftMask, XK_b}},					  toggleborders,  {0} },
	...
	{1, {{MODKEY|ShiftMask, XK_BackSpace}},	  spawn,          {.v = lockcmd } },	
	...
	{1, {{MODKEY|ShiftMask, XK_q}},					  spawn,          {.v = killcmd } },
 	TAGKEYS(                        XK_1,                      0)
 	TAGKEYS(                        XK_2,                      1)
 	TAGKEYS(                        XK_3,                      2)
 	TAGKEYS(                        XK_4,                      2)
